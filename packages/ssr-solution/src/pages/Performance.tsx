  ...
  return (
    <div className='max-w-7xl mx-auto px-6 py-8'>
      ...
      >
        ...
        <h1 className='text-4xl font-bold text-gray-900 mb-4'>SSR 性能优化</h1>
      ...
      >
        <h2 className='text-2xl font-bold text-gray-900 mb-6'>关键性能指标</h2>
      ...
      <motion.div
        ...
        className='ssr-card mb-12'
      >
        <h2 className='text-2xl font-bold text-gray-900 mb-6'>性能优化策略</h2>
