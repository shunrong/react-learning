...
export default function Comparison() {
  const frameworks = [
    {
      ...
      bestFor: ['企业级应用', '电商平台', '内容管理系统', '快速原型开发'],
    },
    {
      name: 'Remix',
      icon: Code,
    ...
    },
    {
      ...
      bestFor: ['特殊性能要求', '学习研究目的', '现有系统集成', '极端定制需求'],
    },
  ];
  ...
  return (
    <div className='max-w-7xl mx-auto px-6 py-8'>
      ...
      >
        <h2 className='text-2xl font-bold text-gray-900 mb-6'>框架概览对比</h2>
            ...
            return (
              ...
              >
                <div className='text-center mb-6'>
                  <div
                    className={`w-16 h-16 bg-${framework.color}-100 rounded-xl flex items-center justify-center mx-auto mb-4`}
                  >
      ...
      <motion.div
        ...
        className='ssr-card mb-12'
      >
        <h2 className='text-2xl font-bold text-gray-900 mb-6'>详细评分对比</h2>
                ...
                <tr key={aspect.aspect} className='border-b border-gray-100'>
                  ...
                  <td className='py-4 px-4 text-center'>
                    <div className='flex flex-col items-center'>
                      <span
                        className={`inline-flex items-center justify-center w-8 h-8 rounded-full text-sm font-bold mb-2 ${getScoreColor(aspect.nextjs.score)}`}
                      >
                        {aspect.nextjs.score}
                      </span>
                  ...
                  <td className='py-4 px-4 text-center'>
                    <div className='flex flex-col items-center'>
                      <span
                        className={`inline-flex items-center justify-center w-8 h-8 rounded-full text-sm font-bold mb-2 ${getScoreColor(aspect.remix.score)}`}
                      >
                        {aspect.remix.score}
                      </span>
                      <span className='text-xs text-gray-500 text-center'>
                  ...
                  <td className='py-4 px-4 text-center'>
                    <div className='flex flex-col items-center'>
                      <span
                        className={`inline-flex items-center justify-center w-8 h-8 rounded-full text-sm font-bold mb-2 ${getScoreColor(aspect.custom.score)}`}
                      >
                        {aspect.custom.score}
                      </span>
                      <span className='text-xs text-gray-500 text-center'>
        ...
        <div className='mt-6 p-4 bg-gray-50 border border-gray-200 rounded-lg'>
          ...
          <div className='flex items-center space-x-6 text-sm'>
            ...
            <div className='flex items-center'>
              <span className='w-4 h-4 bg-yellow-100 text-yellow-600 rounded-full flex items-center justify-center text-xs mr-2'>
                6+
              </span>
              <span className='text-gray-600'>良好</span>
            </div>
            <div className='flex items-center'>
              <span className='w-4 h-4 bg-red-100 text-red-600 rounded-full flex items-center justify-center text-xs mr-2'>
                &lt;6
              </span>
      ...
      <motion.div
        ...
        className='ssr-card'
      >
        <h2 className='text-2xl font-bold text-gray-900 mb-6'>技术选型建议</h2>
        ...
        <div className='mt-8 p-6 bg-gradient-to-r from-indigo-50 to-blue-50 border border-indigo-200 rounded-lg'>
          ...
          <div className='text-sm text-indigo-800 leading-relaxed'>
            <p className='mb-3'>
              <strong>初学者或时间紧张的项目</strong>：推荐
              Next.js，成熟稳定，社区支持好。
            </p>
            <p className='mb-3'>
              <strong>追求现代 Web 体验的项目</strong>：考虑
              Remix，特别是表单密集型应用。
            </p>
            <p>
              <strong>有特殊需求或学习目的</strong>：可以尝试自定义
              SSR，但要做好投入更多时间的准备。
            </p>
          </div>
        </div>
