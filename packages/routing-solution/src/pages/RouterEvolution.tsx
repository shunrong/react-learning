        ...
        <div className='max-w-7xl mx-auto px-6 py-16'>
          ...
          >
            ...
            <p className='text-xl text-route-100 max-w-3xl'>
              探索 React Router 从 2014
              年诞生到今天的完整演进过程，理解每个版本背后的设计理念和技术突破
            </p>
          </motion.div>
        </div>
      </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <div>
                ...
                <p className='text-gray-600 text-sm mb-3'>
                  建议直接学习 React Router v6，它有更现代的 API
                  设计和更好的性能表现。
                </p>
                <a
                  href='/basic'
                  className='text-route-600 text-sm font-medium hover:text-route-700'
                >
                  开始基础教程 →
                </a>
              </div>
