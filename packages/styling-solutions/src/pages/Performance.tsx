...
export default function Performance() {
  ...
  const resetTests = () => {
    ...
    const newResults = mockPerformanceData.map(result => ({
      ...
      metrics: {
        ...
        rerenderCount: Math.max(1, result.metrics.rerenderCount + Math.floor((Math.random() - 0.5) * 4))
      }
    }));
  ...
  const getBestWorst = (metricKey: string) => {
    const values = results.map(r => r.metrics[metricKey as keyof PerformanceMetrics]);
    ...
    <div className='max-w-7xl mx-auto px-6 py-8'>
          ...
          <div className='flex items-center gap-4'>
            ...
            {isRunning && (
              <div className='flex items-center text-blue-600'>
                ...
                <span className='text-sm'>正在测试 {results[currentTest]?.method}...</span>
              </div>
            )}
          </div>
          ...
          return (
            ...
            >
              <div className='flex items-center justify-between mb-4'>
                ...
                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white font-bold text-sm bg-${gradeInfo.color}-500`}>
                  {gradeInfo.grade}
                </div>
              </div>
              ...
              <div className='text-center'>
                ...
                <div className={`text-sm font-medium text-${gradeInfo.color}-600`}>
                  {gradeInfo.label}
                </div>
              </div>
      ...
      <div className='bg-white rounded-xl shadow-sm border border-gray-200 mb-8'>
        <div className='p-6 border-b border-gray-200'>
          <h2 className='text-2xl font-bold text-gray-900 mb-4'>详细性能指标</h2>
              ...
              return (
                <div key={config.key}>
                  ...
                  <div className='space-y-4'>
                    {results.map((result) => {
                      const value = result.metrics[config.key as keyof PerformanceMetrics];
                        ...
                        <div key={result.method} className='space-y-2'>
                          <div className='flex items-center justify-between'>
                            ...
                            <div className='flex items-center gap-2'>
                              ...
                              {isBest && <CheckCircle className='w-4 h-4 text-green-500' />}
                              {isWorst && <AlertTriangle className='w-4 h-4 text-red-500' />}
                            </div>
                          </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-8'>
        <div className='bg-white rounded-xl shadow-sm border border-gray-200 p-6'>
          <div className='flex items-center mb-4'>
            ...
            <h3 className='text-xl font-semibold text-gray-900'>性能优化建议</h3>
          </div>
        ...
        <div className='bg-white rounded-xl shadow-sm border border-gray-200 p-6'>
          <div className='flex items-center mb-4'>
            ...
            <h3 className='text-xl font-semibold text-gray-900'>CSS-in-JS 优化</h3>
          </div>
          ...
          <div className='space-y-4'>
            ...
            <div className='border-l-4 border-pink-500 pl-4'>
              ...
              <p className='text-sm text-gray-600'>
                • 启用 babel-plugin-styled-components<br/>
                • 避免频繁的动态样式计算<br/>
                • 使用 shouldForwardProp 优化属性传递
              </p>
            </div>
          </div>
        </div>
