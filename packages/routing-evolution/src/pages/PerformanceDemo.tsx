              ...
              >
                <div className='card-header'>
                  <div className='flex items-center'>
                    <div
                      className={`w-10 h-10 bg-${technique.color}-100 rounded-lg flex items-center justify-center mr-3`}
                    >
                      <technique.icon
                        className={`w-5 h-5 text-${technique.color}-600`}
                      />
                    </div>
                    <div>
        ...
        >
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
            ...
            <div className='bg-white rounded-lg p-6 text-center'>
              ...
              <div className='text-green-600 text-sm font-medium'>持续监控</div>
            </div>
            ...
            <div className='bg-white rounded-lg p-6 text-center'>
              ...
              <div className='text-blue-600 text-sm font-medium'>永不停歇</div>
            </div>
          </div>
