                    ...
                    <div className='bg-gray-900 rounded-lg p-4'>
                      <div className='space-y-2'>
                        {feature.examples.map((example, idx) => (
                          <div key={idx} className='text-sm text-gray-100 font-mono'>
                            {example}
                          </div>
                        ))}
                      </div>
                  ...
                  <div className='flex items-start'>
                    ...
                    <div>
                      <h4 className={`font-medium ${
                        practice.type === 'do' ? 'text-green-900' : 'text-red-900'
                      }`}>
                        {practice.type === 'do' ? '✅ 推荐' : '❌ 避免'}: {practice.title}
                      </h4>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
            ...
            >
              <div className='card-content text-center'>
                ...
                <p className='text-sm text-gray-600 mb-3'>体验 Link 导航和路由参数</p>
            ...
            >
              <div className='card-content text-center'>
                ...
                <p className='text-sm text-gray-600 mb-3'>学习复杂页面结构设计</p>
            ...
            >
              <div className='card-content text-center'>
                ...
                <p className='text-sm text-gray-600 mb-3'>掌握路由守卫和懒加载</p>
