...
const stats = [
  { label: '路由示例', value: '15+', icon: Route },
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 sm:py-24">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              从基础概念到高级特性，从版本演进到性能优化，
              全面掌握 React 路由系统的方方面面
            </p>
            
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link to="/evolution" className="btn btn-primary text-base px-8 py-3">
                <GitBranch className="w-5 h-5 mr-2" />
                开始学习
              </Link>
              <Link to="/examples/basic" className="btn btn-outline text-base px-8 py-3">
                查看示例
